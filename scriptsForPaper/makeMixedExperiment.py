...
number_of_noise_channels_range=[0]
...
DTo_range=[1,2,3,4]
t_p_range=[0]
input_variables=[ 'FAULT_MEMBER',
                    # 'FAULT_CODE',
                    'ACTIVE']
output_variables=['FAULT_MEMBER',
                    'FAULT_CODE',
                    'ACTIVE']
p0_target_range = [0.8]
...
train_test_val=True
data_mode='artificial_and_real'#can be 'real', 'artificial', 'artificial_and_real'


### parameters for the training
# classifier_name_range = ['svm','linear_svm','random_forest','knn']
classifier_name_range = ['svm','random_forest','knn','fcn','fcn_dropout_twice','fcn_dropout_extreme','cnn']
# classifier_name_range = ['svm','fcn']
nb_epochs=2000
                                                        ...
                                                        for y_column in y_column_range:
                                                            for p0_target in p0_target_range:
                                                                ...
                                                                if data_mode == 'artificial':
                                                                    ...
                                                                    data=pd.read_csv('../data/real_source_data/2014_2017_contains_3L4.zip')
                                                                    data=pd.concat([data,initialData])
                                                                elif data_mode == 'real':
                                                                    data=pd.read_csv('../data/real_source_data/2014_2017_contains_3L4.zip')
                                                                
                                                                ### transform data
                                                                X_s,Y_s,X_times,signals_list_original,target_variable = \
                                                                ...
                                                                for testRatio in testRatio_range:        
                                                                    ...
                                                                    x_train, x_test, signals_list, x_test_final = pts.filterFeatures(x_train,
                                                                                                                                     x_test,
                                                                                                                                     signals_list_original,
                                                                                                                                     threshold=4)
                                                                    ...
                                                                    for classifier_name in classifier_name_range:
                                                                        ...
                                                                        if classifier_name in ['svm','linear_svm','random_forest','knn']:
                                                                            ...
                                                                            if testRatio==0.0:                
                                                                                if classifier_name == 'svm':
                                                                                    svm.InputActivationSVM(outputDir, DTi, deltaT, t_p, [signals_list,target_variable,X_times])
                                                                            ...
                                                                            if testRatio==0.0:                
                                                                                ...
                                                                                iA.inputAnalysisAndReport(x_train,
                                                                                                          ...
                                                                                                          scaler=scaler,
                                                                                                          plot_factor=1,zoom_relevant=False)
                                                                                                          #libRootDir=MLDir) #add again
                                                                        ...
                                                                        parameters={"durationOfSeries":durationOfSeries,
                                                                                 ...
                                                                                 "delayParameterBetweenLastPrecursorAndEventMEAN":delayParameterBetweenLastPrecursorAndEventMEAN,
                                                                                 "delayParameterBetweenLastPrecursorAndEventSTD":delayParameterBetweenLastPrecursorAndEventSTD,
                                                                                 "meanDurationOfConsequenceMEAN":meanDurationOfConsequenceMEAN,
                                                                                 "meanDurationOfConsequenceSTD":meanDurationOfConsequenceSTD,
                                                                                 "delayParameterBetweenEventAndFirstPrecursorMEAN":delayParameterBetweenEventAndFirstPrecursorMEAN,
                                                                                 "delayParameterBetweenEventAndFirstPrecursorSTD":delayParameterBetweenEventAndFirstPrecursorSTD,
