...
train_test_val=True
data_mode='real'#can be 'real', 'artificial', 'artificial_and_real'
                                                        ...
                                                        for y_column in y_column_range:
                                                            for p0_target in p0_target_range:
                                                                ...
                                                                if data_mode == 'artificial':
                                                                    ...
                                                                    data=pd.read_csv('../data/PEMS/PEMS_df.zip')
                                                                
                                                                ### transform data
                                                                X_s,Y_s,X_times,signals_list,target_variable = \
                                                                                pts.transformRealSaveRAMnoTestRatioPEMS(data,
                                                                                                                        deltaT=deltaT,
                                                                                                                        DTi=DTi,
                                                                                                                        DTo=DTo,
                                                                                                                        t_p=t_p,
                                                                ...
                                                                for testRatio in testRatio_range:        
                                                                    ...
                                                                    for classifier_name in classifier_name_range:
                                                                        ...
                                                                        if classifier_name in ['svm','linear_svm','random_forest','knn']:
                                                                            ...
                                                                            if testRatio==0.0:                
                                                                                ### input analysis
                                                                                iA.inputAnalysisAndReport(x_train,y_train,x_test,y_test,outputDir,[signals_list,target_variable,X_times],
                                                                                                          scaler=scaler,plot_factor=1,zoom_relevant=False)
